...
HRESULT BM_Play::RenderAudioSamples (bool preroll){
	...
	// 1s of audio 
	FillNextAudioFrame(audio_input ,(void *) ((uint32_t)audio_buffer + (audioBufferOffset * audioChannelCount * audioSampleDepth/8)), (audioBufferSampleLength * audioChannelCount * (audioSampleDepth / 8)) - (audioBufferOffset * audioChannelCount * audioSampleDepth/8));
	...
	deckLinkOutput->StartScheduledPlayback(0, 600, 1.0);
